...
commonConfig.entry = {
	...
	// 业务
	page: commonConfig.devPath + 'modules/serviceDetail/main.js'
};
...
commonConfig.html = {
	dev : {
		...
		filename: 'index.html',
		template: commonConfig.devPath + 'page/serviceDetails.html',
		// inject:'head',
		// hash:true,
	},
	build : {
		...
		// hash:true,
		// PHP打包写法
		filename: commonConfig.relativePath + 'html/mobile_iphone/settings_customs-increment.php',
		template: commonConfig.devPath + 'page/serviceDetails_build.html',
		// 默认写法
