(function(root, factory) {
	...
	// 绑定支付方式点击事件
	var bindPaymentEvent = function (el, drawEl, callback, maskClose) {
		// console.log(el);
		// console.log(drawEl);
		// 定义循环变量初始值
		...
		if (maskClose) return;
		// 获取阴影元素
		var $mask = drawEl.getElementsByClassName("drawer_mask")[0];
		// 绑定阴影点击事件
	 ...
	 * @param { boolean } maskClose 		点击背景是否移除插件
	 *
	 * */
	var init = function (callback, tplCallback, maskClose, apendEl) {
		// 获取hash
